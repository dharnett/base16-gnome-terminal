...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#000000', '#fb0120', '#a1c659', '#fda331', '#6fb3d2', '#d381c3', '#76c7b7', '#e0e0e0', '#b0b0b0', '#fc6d24', '#303030', '#505050', '#d0d0d0', '#f5f5f5', '#be643c', '#ffffff']"
...
gset string palette "['#000000', '#fb0120', '#a1c659', '#fda331', '#6fb3d2', '#d381c3', '#76c7b7', '#e0e0e0', '#b0b0b0', '#fc6d24', '#303030', '#505050', '#d0d0d0', '#f5f5f5', '#be643c', '#ffffff']"
