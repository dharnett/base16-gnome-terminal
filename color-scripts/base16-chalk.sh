...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#151515', '#fb9fb1', '#acc267', '#ddb26f', '#6fc2ef', '#e1a3ee', '#12cfc0', '#d0d0d0', '#505050', '#eda987', '#202020', '#303030', '#b0b0b0', '#e0e0e0', '#deaf8f', '#f5f5f5']"
...
gset string palette "['#151515', '#fb9fb1', '#acc267', '#ddb26f', '#6fc2ef', '#e1a3ee', '#12cfc0', '#d0d0d0', '#505050', '#eda987', '#202020', '#303030', '#b0b0b0', '#e0e0e0', '#deaf8f', '#f5f5f5']"
