...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#191919', '#dc657d', '#84b97c', '#c3ba63', '#639ee4', '#b888e2', '#4bb1a7', '#a7a7a7', '#5f5a60', '#4bb1a7', '#202020', '#303030', '#505050', '#808080', '#b888e2', '#ffffff']"
...
gset string palette "#191919:#dc657d:#84b97c:#c3ba63:#639ee4:#b888e2:#4bb1a7:#a7a7a7:#5f5a60:#dc657d:#84b97c:#c3ba63:#639ee4:#b888e2:#4bb1a7:#ffffff"
gset string palette "['#191919', '#dc657d', '#84b97c', '#c3ba63', '#639ee4', '#b888e2', '#4bb1a7', '#a7a7a7', '#5f5a60', '#4bb1a7', '#202020', '#303030', '#505050', '#808080', '#b888e2', '#ffffff']"
