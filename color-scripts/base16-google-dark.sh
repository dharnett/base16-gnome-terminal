...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#1d1f21', '#cc342b', '#198844', '#fba922', '#3971ed', '#a36ac7', '#3971ed', '#c5c8c6', '#969896', '#f96a38', '#282a2e', '#373b41', '#b4b7b4', '#e0e0e0', '#3971ed', '#ffffff']"
...
gset string palette "['#1d1f21', '#cc342b', '#198844', '#fba922', '#3971ed', '#a36ac7', '#3971ed', '#c5c8c6', '#969896', '#f96a38', '#282a2e', '#373b41', '#b4b7b4', '#e0e0e0', '#3971ed', '#ffffff']"
