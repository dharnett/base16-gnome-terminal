...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset cursor-background-color "'#b5b3aa'"
...
gset string palette "['#000000', '#ff6c60', '#a8ff60', '#ffffb6', '#96cbfe', '#ff73fd', '#c6c5fe', '#b5b3aa', '#6c6c66', '#e9c062', '#242422', '#484844', '#918f88', '#d9d7cc', '#b18a3d', '#fdfbee']"
gset string background_color "#000000"
gset string foreground_color "#b5b3aa"
gset string bold_color "#b5b3aa"
gset bool   bold_color_same_as_fg "true"
gset bool   cursor-colors-set "true"
gset string cursor-background-color "'#b5b3aa'"
