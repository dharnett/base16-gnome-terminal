...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#000000', '#ff0000', '#33ff00', '#ff0099', '#0066ff', '#cc00ff', '#00ffff', '#d0d0d0', '#808080', '#ff9900', '#404040', '#606060', '#c0c0c0', '#e0e0e0', '#3300ff', '#ffffff']"
...
gset string palette "['#000000', '#ff0000', '#33ff00', '#ff0099', '#0066ff', '#cc00ff', '#00ffff', '#d0d0d0', '#808080', '#ff9900', '#404040', '#606060', '#c0c0c0', '#e0e0e0', '#3300ff', '#ffffff']"
