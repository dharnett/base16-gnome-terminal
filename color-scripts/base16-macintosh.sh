...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#000000', '#dd0907', '#1fb714', '#fbf305', '#0000d3', '#4700a5', '#02abea', '#c0c0c0', '#808080', '#ff6403', '#404040', '#404040', '#808080', '#c0c0c0', '#90713a', '#ffffff']"
...
gset string palette "['#000000', '#dd0907', '#1fb714', '#fbf305', '#0000d3', '#4700a5', '#02abea', '#c0c0c0', '#808080', '#ff6403', '#404040', '#404040', '#808080', '#c0c0c0', '#90713a', '#ffffff']"
