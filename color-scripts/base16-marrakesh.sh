...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#201602', '#c35359', '#18974e', '#a88339', '#477ca1', '#8868b3', '#75a738', '#948e48', '#6c6823', '#b36144', '#302e00', '#5f5b17', '#86813b', '#ccc37a', '#b3588e', '#faf0a5']"
        dset background-color "'#201602'"
        dset foreground-color "'#948e48'"
        dset bold-color "'#948e48'"
        dset bold-color-same-as-fg "true"
        dset cursor-colors-set "true"
        dset cursor-background-color "'#948e48'"
        dset cursor-foreground-color "'#201602'"
...
gset string palette "['#201602', '#c35359', '#18974e', '#a88339', '#477ca1', '#8868b3', '#75a738', '#948e48', '#6c6823', '#b36144', '#302e00', '#5f5b17', '#86813b', '#ccc37a', '#b3588e', '#faf0a5']"
gset string background_color "#201602"
gset string foreground_color "#948e48"
gset string bold_color "#948e48"
gset bool   bold_color_same_as_fg "true"
gset bool   cursor-colors-set "true"
gset string cursor-background-color "'#948e48'"
gset string cursor-foreground-color "'#201602'"
