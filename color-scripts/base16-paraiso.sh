...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset cursor-background-color "'#a39e9b'"
        dset cursor-foreground-color "'#2f1e2e'"
...
gset string palette "['#2f1e2e', '#ef6155', '#48b685', '#fec418', '#06b6ef', '#815ba4', '#5bc4bf', '#a39e9b', '#776e71', '#f99b15', '#41323f', '#4f424c', '#8d8687', '#b9b6b0', '#e96ba8', '#e7e9db']"
gset string background_color "#2f1e2e"
gset string foreground_color "#a39e9b"
gset string bold_color "#a39e9b"
gset bool   bold_color_same_as_fg "true"
gset bool   cursor-colors-set "true"
gset string cursor-background-color "'#a39e9b'"
gset string cursor-foreground-color "'#2f1e2e'"
