...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset cursor-background-color "'#5f574f'"
...
gset string palette "#000000:#ff004d:#00e756:#fff024:#83769c:#ff77a8:#29adff:#5f574f:#008751:#ff004d:#00e756:#fff024:#83769c:#ff77a8:#29adff:#fff1e8"
gset string palette "['#000000', '#ff004d', '#00e756', '#fff024', '#83769c', '#ff77a8', '#29adff', '#5f574f', '#008751', '#ffa300', '#1d2b53', '#7e2553', '#ab5236', '#c2c3c7', '#ffccaa', '#fff1e8']"
gset string background_color "#000000"
gset string foreground_color "#5f574f"
gset string bold_color "#5f574f"
gset bool   bold_color_same_as_fg "true"
gset bool   cursor-colors-set "true"
gset string cursor-background-color "'#5f574f'"
