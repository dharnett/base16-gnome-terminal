...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#000000', '#eb008a', '#37b349', '#f8ca12', '#0e5a94', '#b31e8d', '#00aabb', '#d0d0d0', '#505050', '#f29333', '#202020', '#303030', '#b0b0b0', '#e0e0e0', '#7a2d00', '#ffffff']"
...
gset string palette "['#000000', '#eb008a', '#37b349', '#f8ca12', '#0e5a94', '#b31e8d', '#00aabb', '#d0d0d0', '#505050', '#f29333', '#202020', '#303030', '#b0b0b0', '#e0e0e0', '#7a2d00', '#ffffff']"
