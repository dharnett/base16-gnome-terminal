...
if which "$DCONF" > /dev/null 2>&1; then
    ...
    if [[ -n "`$DCONF list $BASE_KEY_NEW/`" ]]; then
        ...
        dset palette "['#2b2b2b', '#da4939', '#a5c261', '#ffc66d', '#6d9cbe', '#b6b3eb', '#519f50', '#e6e1dc', '#5a647e', '#cc7833', '#272935', '#3a4055', '#d4cfc9', '#f4f1ed', '#bc9458', '#f9f7f3']"
        dset background-color "'#2b2b2b'"
        dset foreground-color "'#e6e1dc'"
        dset bold-color "'#e6e1dc'"
        dset bold-color-same-as-fg "true"
        dset cursor-colors-set "true"
        dset cursor-background-color "'#e6e1dc'"
...
gset string palette "['#2b2b2b', '#da4939', '#a5c261', '#ffc66d', '#6d9cbe', '#b6b3eb', '#519f50', '#e6e1dc', '#5a647e', '#cc7833', '#272935', '#3a4055', '#d4cfc9', '#f4f1ed', '#bc9458', '#f9f7f3']"
gset string background_color "#2b2b2b"
gset string foreground_color "#e6e1dc"
gset string bold_color "#e6e1dc"
gset bool   bold_color_same_as_fg "true"
gset bool   cursor-colors-set "true"
gset string cursor-background-color "'#e6e1dc'"
